...
import com.matheushudson.cursomc.services.exception.DateIntegrityException;
...
public class ResourceExecptionHandler {
	...
	public ResponseEntity<StandardError> dateIntegrityException(ObjectNotFoundException e, HttpServletRequest request) {
